...
const Nav = () => {
  return (
    <nav className='w-screen flex md:flex items-center lg:justify-evenly md:flex-wrap w-12/12 ml-4  '>
        <div className='nav1 w-52 h-18 text-left md:w-60 md:h-18  ' >
        <NavLink to="/"><img  src='images/logo.svg' /></NavLink>
            
        </div>
        <div className='nav2 md:w-6/12 hidden lg:flex flex-col items-center md:flex-row md:items-center md:flex-wrap justify-around py-2 mt-2 text-base'>
        ...
        <div className='hamburger w-6/12  lg:hidden '>
