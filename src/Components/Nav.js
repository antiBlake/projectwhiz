...
const Nav = () => {
  ...
  return (
    ...
    <nav className='flex md:flex items-center lg:justify-evenly md:flex-wrap w-12/12   '>
        ...
        <div className={`hamburger w-5/12 flex justify-end ${navbutton ? "hidden" : "block"} lg:hidden`} onClick={handleclick}>
  ...
  <path fillRule="evenodd" d="M3 5a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 10a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 15a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1z" clipRule="evenodd" />
    ...
    <div className={`mobilenav transition-all ease-in-out duration-300 ${navbutton ? "block" : "hidden"} `}>
